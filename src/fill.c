 ...
 */
static gint
get_color (struct FillInfo *fill_info, gint x, gint y)
{
...
static gboolean
is_similar_to_old_pixel_value (struct FillInfo *fill_info, gdouble x, gdouble y)
{
...
void
set_new_pixel_value (struct FillInfo *fill_info, gint x, gint y)
{
